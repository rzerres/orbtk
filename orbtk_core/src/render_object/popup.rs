...
/// The supported relative position of the popup in relation to the target.
#[derive(Clone, Debug, PartialEq)]
...
impl RelativePosition {
    /// Calculate the `distance` between popup and parent target (64bit float).
    ...
    /// Involved widgets will respecting given distance.
